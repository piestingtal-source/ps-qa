...
<div id="qa-page-wrapper">
	...
	<div id="single-question">
		...
		<div id="single-question-container">
			...
			<div id="question-body">
				...
				<?php the_question_category(  __( 'Kategorie:', QA_TEXTDOMAIN ) . ' <span class="question-category">', '', '</span>' ); ?>
				<?php the_question_tags( __( 'Tags:', QA_TEXTDOMAIN ) . ' <span class="question-tags">', ' ', '</span>' ); ?>
				<span id="qa-lastaction"><?php _e( 'fragte', QA_TEXTDOMAIN ); ?> <?php the_qa_time( get_the_ID() ); ?></span>
	...
	<div id="edit-answer">
		...
		<h2><?php _e( 'Deine Antwort', QA_TEXTDOMAIN ); ?></h2>
		<?php the_answer_form(); ?>
